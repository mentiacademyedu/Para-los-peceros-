...
const STRINGS = {
  en: {
    ...
    'depth.note': 'Open-raise (RFI) charts adjust by stack depth where data exists. Other spots still use the 100bb baseline.',
  ...
  es: {
    ...
    'depth.note': 'Los rangos de apertura (RFI) se ajustan por profundidad cuando hay datos. Los demás spots usan la base de 100bb.',
